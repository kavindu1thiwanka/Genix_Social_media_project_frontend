      ...
      <div className="bg-white w-full max-h-screen flex items-center justify-center py-4">
        <div className="w-[30%] flex items-center justify-center flex-col text-center px-12 py-10">
          ...
          <form className="w-full flex flex-col space-y-3 text-left">
            ...
            <p className="text-sm text-center">By clicking Sign Up, you agree to our Terms, Privacy Policy and Cookies Policy. You may receive SMS notifications from us and can opt out at any time.</p>
          </form>
        </div>
      </div>
    );
